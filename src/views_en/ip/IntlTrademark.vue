<template>
  <div class="intl-trademark-page">
    <Top />
    <IntlTrademarkContent1 />
    <Link />
    <IntlTrademarkContent2 />
    <Bottom1 />
  </div>
</template>

<script setup>
import IntlTrademarkContent1 from '@/components_en/ip/intl/IntlTrademark_content1.vue'
