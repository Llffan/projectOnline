...
import '@/css/company/ws/Ws_content2.css'
...
const registrationProcess = [
    ...
    },
    {
        ...
        title: '第六步 后续服务',
        description: '协助开设银行账户，提供年审等后续服务。'
    }
]
...
const advantages = [
    ...
    },
    {
        ...
        title: '专业增值服务',
        description: '十洲通在境外拥有自己的团队，也与境外的各大银行、事务所、税务机构建立了良好的合作关系。'
    },
    {
        imgSrc: new URL('@/assets/img/temp_img/5.jpg', import.meta.url).href,
        title: '专业专属商务对接',
        description: '我们的顾问、咨询师、会计师等多数毕业于国内外著名大学，对于每个客户都会建立计划小组。'
    }
]
