        ...
        <div class="content_box">
            <div class="content1">
                ...
                <div class="intro">
                    ...
                    <div class="text">
                        <P>Thailand is Southeast Asia's second largest economy with an open investment environment and good infrastructure.</P>
                        <P>As an important ASEAN member country, Thailand has close economic and trade relations with China, with cooperation deepening under the Belt and Road Initiative.</P>
                        <P>With its unique geographical advantages and abundant natural resources, Thailand has become an important investment destination for foreign investors in Southeast Asia.</P>
                    </div>
                </div>
            </div>
            <div class="content2">
...
import '@/css_en/company/th/Th_content2.css'
...
const advantage = [
    {
        img: '',
        adv: 'Superior geographical location connecting markets across Southeast Asia'
    },
    {
        img: '',
        adv: 'Stable policies and favorable investment environment'
    },
    {
        img: '',
        adv: 'Relatively low labor costs and abundant human resources'
    },
    {
        img: '',
        adv: 'Well-developed tourism industry and broad consumer market'
    },
    {
        img: '',
        adv: 'Government encourages foreign investment with many preferential policies'
    },
    {
        img: '',
...
const faqs = ref([
    {
        question: "How much capital is required to register a company in Thailand?",
        answer: "There is no minimum limit for registered capital in Thailand. Generally, it is recommended to have registered capital of 2 million THB, without capital verification."
    },
    {
        question: "How long does it take to register a company in Thailand?",
        answer: "Under normal circumstances, it takes 5-7 working days to register a company in Thailand."
    },
    {
        question: "Does a Thai company need annual review?",
        answer: "Yes, Thai companies need annual reviews, including submission of annual reports and renewal of commercial registration certificates."
    },
    {
        question: "How is tax filing conducted for Thai companies?",
        answer: "Thai companies need to file corporate income tax annually with the tax authorities. The first tax filing can be exempted from audit."
    },
    {
        question: "What are the accounting and auditing requirements for Thai companies?",
        answer: "Thai companies need to do accounting and auditing annually, regardless of whether there is business activity or not."
    },
    {
        question: "Can Thai companies operate in mainland China?",
        answer: "Thai companies cannot directly operate in mainland China. To operate in mainland China, it is necessary to establish a representative office or invest in establishing a foreign-invested enterprise."
    }
])
