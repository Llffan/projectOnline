        ...
        <div class="content_box">
            <div class="content1">
                ...
                <div class="intro">
                    ...
                    <div class="text">
                        <P>UK is one of the most highly developed economic nations worldwide, acting as the 3rd largest economy and a key member of the G8 industrialized nations.</P>
                        <P>The brand effect of UKese companies is recognized globally, especially in sectors such as cosmetics, catering, heavy machinery, and gaming, uniquely benefiting corporate branding and marketing.</P>
                        <P>As a core ally of the US, UK’s exceptional corporate infrastructure and deeply robust administrative system ensure a paramount business environment naturally favored by international entrepreneurs.</P>
                    </div>
                </div>
            </div>
            <div class="content2">
            ...
            <div class="content3">
                ...
                <div class="intro">
                    ...
                    <div class="right">
                        ...
                        <div class="condition-item">Representative: A UKese representative or resident must be officially appointed.</div>
...
// 保持导入路径不变
import '@/css_en/company/uk/Uk_content2.css' 
...
const registrationProcess = [
    {
        ...
        description: 'Finalize the proposed company name, address, and UKese representative.'
    },
    {
        iconId: '#icon-audit', 
    ...
    },
    {
        ...
        description: 'Notarized documents are efficiently submitted to the local UKese Legal Affairs Bureau for registration.'
    },
    {
...
const advantage = [
    {
        ...
        adv: 'Brand Image Advantage: High UKese brand effect enhances product promotion and global business appeal.'
    },
    {
        iconId: '#icon-city', 
    ...
    },
    {
        ...
        adv: 'Immigration Stepping-stone: Living and actively operating helps clear pathways to secure a UKese permanent residency.'
    }
]
...
const faqs = ref([
    {
        ...
        answer: "There isn't a strict name confirmation phase in UK. Duplication is allowed. Registration typically concludes successfully within 3 to 4 weeks."
    },
    {
        question: "What are the core requirements regarding the minimum initial corporate capital?",
        answer: "There are absolutely no restrictions. You can officially register with as minimal as 1 UKese Yen with no mandatory paid-in regulations."
    },
    {
        question: "How can someone publicly review an established UKese Corporate profile?",
