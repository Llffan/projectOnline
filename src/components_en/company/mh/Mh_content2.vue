        ...
        <div class="content_box">
            <div class="content1">
                ...
                <div class="intro">
                    ...
                    <div class="text">
                        <P>The Marshall Islands is an island nation in the Pacific, famous for its stable political situation and favorable business environment. It is one of the important offshore financial centers in the Asia-Pacific region.</P>
                        <P>The Marshall Islands has a sound legal system and favorable tax policies, providing a good business environment and investment opportunities for global investors.</P>
                        <P>Marshall Islands International Business Companies (IBC) enjoy advantages such as tax exemption, asset protection, and privacy protection, making them ideal for international trade, investment holding, and wealth management.</P>
                    </div>
                </div>
            </div>
            <div class="content2">
            ...
            <div class="content6">
                <div class="title">
                    Frequently Asked Questions About Marshall Islands Company Registration
                </div>
                <div class="intro">
                    <div 
...
import '@/css_en/company/mh/Mh_content2.css'
...
const registrationProcess = [
    ...
    },
    {
        ...
        description: 'Submit complete registration application documents to the relevant Marshall Islands authorities.'
    },
    {
        img: '',
...
const advantage = [
    {
        img: '',
        adv: 'Tax benefits, Marshall Islands companies are exempt from income tax, capital gains tax, etc.'
    },
    {
        img: '',
...
const faqs = ref([
    {
        question: "How much capital is required to register a Marshall Islands company?",
        answer: "There is no minimum registered capital requirement for Marshall Islands companies. Generally, a registered capital of 50,000 USD is recommended, with no capital verification required."
    },
    {
        question: "How long does it take to register a Marshall Islands company?",
        answer: "Generally, Marshall Islands company registration takes 3-5 working days."
    },
    {
        question: "Does a Marshall Islands company need annual review?",
        answer: "Yes, Marshall Islands companies must undergo annual review and submit financial statements."
    },
    {
        question: "How is tax filing conducted for Marshall Islands companies?",
        answer: "Marshall Islands companies are not required to pay taxes locally, but must submit annual returns on time."
    },
    {
        question: "Can foreigners register a company in the Marshall Islands?",
        answer: "Yes, foreigners can register companies in the Marshall Islands without any restrictions."
    },
    {
        question: "Can a Marshall Islands company operate in Mainland China?",
        answer: "A Marshall Islands company cannot directly operate in mainland China. To operate in China, a representative office must be established or a foreign investment enterprise must be set up."
    }
])
