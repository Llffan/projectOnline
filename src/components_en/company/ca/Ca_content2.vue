        ...
        <div class="content_box">
            <div class="content1">
                ...
                <div class="intro">
                    ...
                    <div class="text">
                        <P>Canada is one of the most developed countries in the world, with a stable economic environment and a sound legal system.</P>
                        <P>As a G7 member country, Canada has strong competitiveness in technology, energy, finance and other fields, and is an important economy in North America.</P>
                        <P>With its high-quality living environment, open immigration policy, and excellent business environment, Canada has become the ideal choice for global investors and entrepreneurs.</P>
                    </div>
                </div>
            </div>
            <div class="content2">
            ...
            <div class="content6">
                <div class="title">
                    Frequently Asked Questions About Registering a Company in Canada
                </div>
                <div class="intro">
                    <div 
...
import '@/css_en/company/ca/Ca_content2.css'
...
const advantage = [
    {
        img: '',
        adv: 'Stable political environment and sound legal system'
    },
    {
        img: '',
        adv: 'Abundant natural resources and solid economic foundation'
    },
    {
        img: '',
        adv: 'Reasonable tax policies and excellent business environment'
    },
    {
        img: '',
        adv: 'High education level and sufficient talent resources'
    },
    {
        img: '',
        adv: 'Superior geographical location and convenient trade'
    },
    {
        img: '',
        adv: 'Sound social welfare and high quality of life'
    }
]
...
const faqs = ref([
    {
        question: "How much capital is required to register a company in Canada?",
        answer: "There is no minimum limit for registered capital in Canada. Generally, it is recommended to have registered capital of 1 CAD, without capital verification."
    },
    {
        question: "How long does it take to register a company in Canada?",
        answer: "Under normal circumstances, it takes 3-5 working days to register a company in Canada."
    },
    {
        question: "Does a Canadian company need annual review?",
        answer: "Yes, Canadian companies need annual reviews, including submission of annual reports and renewal of commercial registration certificates."
    },
    {
        question: "How is tax filing conducted for Canadian companies?",
        answer: "Canadian companies need to file corporate income tax annually with the tax authorities. The first tax filing can be exempted from audit."
    },
    {
        question: "What are the accounting and auditing requirements for Canadian companies?",
        answer: "Canadian companies need to do accounting and auditing annually, regardless of whether there is business activity or not."
    },
    {
        question: "Can Canadian companies operate in mainland China?",
        answer: "Canadian companies cannot directly operate in mainland China. To operate in mainland China, it is necessary to establish a representative office or invest in establishing a foreign-invested enterprise."
    }
])
