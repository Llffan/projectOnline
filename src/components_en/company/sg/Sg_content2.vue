        ...
        <div class="content_box">
            <div class="content1">
                ...
                <div class="intro">
                    ...
                    <div class="text">
                        <P>Singapore is one of the Four Asian Tigers, with a highly developed economy and excellent business environment.</P>
                        <P>As one of the most internationalized countries in the world, Singapore is renowned for its clean and efficient government, sound legal system, and business-friendly environment.</P>
                        <P>With its superior geographical location, advanced infrastructure, and open economic policies, Singapore has become an important operational base for companies in Asia and around the globe.</P>
                    </div>
                </div>
            </div>
            <div class="content2">
...
import '@/css_en/company/sg/Sg_content2.css'
...
const advantage = [
    ...
    {
        img: '',
        adv: 'Clean and efficient government with excellent business environment'
    },
    {
        img: '',
        adv: 'Sound legal system with strict intellectual property protection'
    },
    {
        img: '',
        adv: 'Favorable tax policies with no foreign exchange control'
    },
    {
        img: '',
        adv: 'Financial center status facilitating financing and investment'
    },
    {
        img: '',
        adv: 'Concentration of highly qualified talents with high degree of internationalization'
    }
]
...
const faqs = ref([
    {
        question: "How much capital is required to register a company in Singapore?",
        answer: "There is no minimum limit for registered capital in Singapore. Generally, it is recommended to have registered capital of 1 SGD, without capital verification."
    },
    {
        question: "How long does it take to register a company in Singapore?",
        answer: "Under normal circumstances, it takes 1-3 working days to register a company in Singapore."
    },
    {
        question: "Does a Singapore company need annual review?",
        answer: "Yes, Singapore companies need annual reviews, including submission of annual reports and renewal of commercial registration certificates."
    },
    {
        question: "How is tax filing conducted for Singapore companies?",
        answer: "Singapore companies need to file corporate income tax annually with the tax authorities. The first tax filing can be exempted from audit."
    },
    {
        question: "What are the accounting and auditing requirements for Singapore companies?",
        answer: "Singapore companies need to do accounting and auditing annually, regardless of whether there is business activity or not."
    },
    {
        question: "Can Singapore companies operate in mainland China?",
        answer: "Singapore companies cannot directly operate in mainland China. To operate in mainland China, it is necessary to establish a representative office or invest in establishing a foreign-invested enterprise."
    }
])
