        ...
        <div class="content_box">
            <div class="content1">
                ...
                <div class="intro">
                    ...
                    <div class="text">
                        <P>The Cayman Islands is the world's fourth largest offshore financial center, renowned globally for its stable legal system, relaxed regulatory environment, and favorable tax policies.</P>
                        <P>As a British Overseas Territory, the Cayman Islands has a well-established common law legal system, providing a secure and reliable investment environment for global investors.</P>
                        <P>Cayman companies enjoy advantages such as zero taxation, high confidentiality, and no foreign exchange controls, making it the preferred offshore jurisdiction for international investment, fund establishment, and wealth management.</P>
                    </div>
                </div>
            </div>
            <div class="content2">
            ...
            <div class="content6">
                <div class="title">
                    Frequently Asked Questions About Cayman Islands Company Registration
                </div>
                <div class="intro">
                    <div 
...
import '@/css_en/company/ky/Ky_content2.css'
...
const registrationProcess = [
    ...
    },
    {
        ...
        description: 'Submit complete registration application documents to the relevant Cayman authorities.'
    },
    {
        img: '',
...
const advantage = [
    {
        img: '',
        adv: 'Zero tax policy, Cayman companies are exempt from income tax, capital gains tax, etc.'
    },
    {
        img: '',
...
const faqs = ref([
    {
        question: "How much capital is required to register a Cayman company?",
        answer: "There is no minimum registered capital requirement for Cayman companies. Generally, a registered capital of 50,000 USD is recommended, with no capital verification required."
    },
    {
        question: "How long does it take to register a Cayman company?",
        answer: "Generally, Cayman company registration takes 3-5 working days."
    },
    {
        question: "Does a Cayman company need annual review?",
        answer: "Yes, Cayman companies must undergo annual review and submit financial statements."
    },
    {
        question: "How is tax filing conducted for Cayman companies?",
        answer: "Cayman companies are not required to pay taxes locally, but must submit annual returns on time."
    },
    {
        question: "Can foreigners register a company in the Cayman Islands?",
        answer: "Yes, foreigners can register companies in the Cayman Islands without any restrictions."
    },
    {
        question: "Can a Cayman company operate in Mainland China?",
        answer: "A Cayman company cannot directly operate in mainland China. To operate in China, a representative office must be established or a foreign investment enterprise must be set up."
    }
])
