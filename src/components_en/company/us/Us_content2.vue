        ...
        <div class="content_box">
            <div class="content1">
                ...
                <div class="intro">
                    ...
                    <div class="text">
                        <P>The USA is the world's largest economy, with a sound legal system and highly developed capital markets.</P>
                        <P>As a world center for technological innovation, the USA leads global development in fields such as internet, artificial intelligence, and biotechnology.</P>
                        <P>With its open business environment, strong consumer market, and advanced infrastructure, the USA has become a major investment destination for global enterprises.</P>
                    </div>
                </div>
            </div>
            <div class="content2">
            ...
            <div class="content6">
                <div class="title">
                    Frequently Asked Questions About Registering a Company in the USA
                </div>
                <div class="intro">
                    <div 
...
import '@/css_en/company/us/Us_content2.css'
...
const advantage = [
    {
        img: '',
        adv: 'World\'s largest economy with huge market potential'
    },
    {
        img: '',
    ...
    {
        img: '',
        adv: 'Highly developed capital markets with diverse financing channels'
    },
    {
        img: '',
        adv: 'Excellent environment for technological innovation with talent concentration'
    },
    {
        img: '',
        adv: 'Huge consumer market with strong purchasing power'
    },
    {
        img: '',
        adv: 'Well-developed infrastructure and excellent business environment'
    }
]
...
const faqs = ref([
    {
        question: "How much capital is required to register a company in the USA?",
        answer: "There is no minimum limit for registered capital in the USA. Generally, it is recommended to have registered capital of 1,000 USD, without capital verification."
    },
    {
        question: "How long does it take to register a company in the USA?",
        answer: "Under normal circumstances, it takes 5-7 working days to register a company in the USA."
    },
    {
        question: "Does a USA company need annual review?",
        answer: "Yes, USA companies need annual reviews, including submission of annual reports and renewal of commercial registration certificates."
    },
    {
        question: "How is tax filing conducted for USA companies?",
        answer: "USA companies need to file corporate income tax annually with the tax authorities. The first tax filing can be exempted from audit."
    },
    {
        question: "What are the accounting and auditing requirements for USA companies?",
        answer: "USA companies need to do accounting and auditing annually, regardless of whether there is business activity or not."
    },
    {
        question: "Can USA companies operate in mainland China?",
        answer: "USA companies cannot directly operate in mainland China. To operate in mainland China, it is necessary to establish a representative office or invest in establishing a foreign-invested enterprise."
    }
])
