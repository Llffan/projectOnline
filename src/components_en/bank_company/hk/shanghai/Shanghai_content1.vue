<template>
    <div class="shanghai_content1">
        ...
        <div class="intro">
            ...
            <div class="subtitle">Shanghai Commercial Bank (Hong Kong) Account Opening Service: Comprehensive Guide for Corporate and Personal Accounts, Advantages, Document Checklist, Process, and FAQs</div>
...
import '@/css_en/bank_company/hk/shanghai/Shanghai_content1.css'
