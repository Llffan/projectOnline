<template>
    <div class="communications_content1">
        ...
        <div class="intro">
            ...
            <div class="subtitle">Bank of Communications (Hong Kong) Account Opening Service: Comprehensive Guide for Corporate and Personal Accounts, Advantages, Document Checklist, Process, and FAQs</div>
...
import '@/css_en/bank_company/hk/communications/Communications_content1.css'
