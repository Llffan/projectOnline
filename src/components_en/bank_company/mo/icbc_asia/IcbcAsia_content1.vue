<template>
    <div class="mo_icbc_asia_content1">
        ...
        <div class="intro">
            ...
            <div class="subtitle">ICBC Asia Macau Account Opening Service: Comprehensive Guide for Corporate and Personal Accounts, Advantages, Document Checklist, Process, and FAQs</div>
...
import '@/css_en/bank_company/mo/icbc_asia/IcbcAsia_content1.css'
